...
public partial class Ticketadd : System.Web.UI.Page
{
         ...
         if (!IsPostBack)
         {
            ...
            if (Session["name1"] != null)
            {
                ...
                if (dr.Read())
                {
                    ...
                    TextBox11.Text = dr["payment_received"].ToString();
    ...
    private void ticketstatus()
    {
        ...
        DropDownList5.DataTextField = "Ticket_status";
