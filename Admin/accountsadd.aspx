                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Phone</label>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Website</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Status</label>
                                    ...
                                    <div class="col-lg-9"><asp:CheckBox ID="CheckBox2" runat="server" Text="Active"></asp:CheckBox> &nbsp;&nbsp;<asp:CheckBox ID="CheckBox3" runat="server" Text="Inactive"></asp:CheckBox></div>
                                </div>
