...
public partial class Ticket : System.Web.UI.Page
{
    ...
    private void ticketstatus()
    {
        ...
        SqlCommand cmd = new SqlCommand("Select * from Ticket_status where com_id='" + company_id + "' ORDER BY No asc", con);
        con.Open();
        ...
        DropDownList2.DataTextField = "Ticket_status";
        DropDownList2.DataValueField = "No";
        DropDownList2.DataBind();
        DropDownList2.Items.Insert(0, new ListItem("-- Choose Option --", "0"));

        con.Close();
    }
    private void ticketcategory()
    {
        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd = new SqlCommand("Select * from Ticket_category where com_id='" + company_id + "' ORDER BY No asc", con);
        con.Open();
        DataSet ds = new DataSet();
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        da.Fill(ds);
        ...
        DropDownList6.DataTextField = "Ticket_category";
