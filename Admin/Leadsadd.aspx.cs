...
public partial class Leadsadd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            company_id = Convert.ToInt32(Session["company_id"].ToString());
            SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
            SqlCommand cmd = new SqlCommand("insert into lead_entry values(@Lead_name,@Account_name,@Phone,@email,@Product,@status,@lead_source,@Assigned_to,@Share_with,@Summary,@Alter_email,@alter_phone,@Customer_type,@compaign,@address,@add_city,@add_state,@add_zip,@Country,@com_id,@edit_date,@created_date)", con);
