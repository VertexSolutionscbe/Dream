                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                 <h2><asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<span style="font-size:16px">Created By <asp:Label ID="Label2" runat="server" Text=""></asp:Label>&nbsp;On <asp:Label ID="Label10" runat="server" Text=""></asp:Label></span><Span style="float:right"><asp:DropDownList ID="DropDownList1"  runat="server" CssClass="selectpicker" data-style="btn-primary1" data-width="100%"  ></asp:DropDownList>  <asp:LinkButton ID="btnRandom" runat="server" CssClass="btn btn-primary" 
