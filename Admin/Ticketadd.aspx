          ...
          <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
           <asp:AsyncPostBackTrigger ControlID = "Button47" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID = "ImageButton3" EventName="Click" />
                                    ...
                                    <asp:Panel ID="Panel1" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="2px" CssClass="panelx" style="display:none">
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button47" EventName="Click" />
                    ...
                    <ContentTemplate>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" BorderColor="#999999" BackColor="White" BorderWidth="2px" CssClass="panelx" style="display:none">
...
<div class="container">
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button6" EventName="Click" />
             <asp:AsyncPostBackTrigger ControlID = "ImageButton4" EventName="Click" />
                                ...
                                <asp:Panel ID="Panel3" runat="server" runat="server" BorderColor="#999999" BackColor="White" BorderWidth="2px" CssClass="panelx" style="display:none"  >
