                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                <h2>Invoice details <Span style="float:right">
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Date" DataField="Dated1" />
               <asp:BoundField HeaderText="Company name" DataField="Com_name" />
           ...
           <ItemTemplate>
               ...
               <asp:ImageButton ID="ImageButton1" runat="server" 
                   onclick="ImageButton1_Click" Height="20px" ImageUrl="~/edit4.jpg"
                   Width="20px"  />
           </ItemTemplate>
               ...
               <asp:TemplateField>
           <ItemTemplate>
               <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/delete3.png" Width="20px" Height="20px"  onclick="ImageButton3_Click" />
           </ItemTemplate>
           ...
           <ItemTemplate>
               ...
               <asp:DropDownList ID="ddlFileFormat" CssClass="text4" runat="server">
           ...
           <ItemTemplate>
               ...
               <asp:Button ID="Button11" runat="server" Text="View"  onclick="Button11_Click" /></ItemTemplate>
