...
arrow"></span></a>
              ...
              <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label22" runat="server" Text="Campaign Type" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel5" runat="server" BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none" >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel6" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
 ...
 <h3 style="font-size:20px; ">Add a new campaign Status</h3> 
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel2" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label5" runat="server" Text="Campaign Response" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel3" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel4" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<div class="col-md-12" style="margin-top:-16px;">
            ...
            <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label9" runat="server" Text="Lead Status" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel7" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel8" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label13" runat="server" Text="Lead Source" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel9" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel10" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label17" runat="server" Text="Priority" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel11" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel12" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label21" runat="server" Text="Opportunity Stage" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel13" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel14" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
     ...
     <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label26" runat="server" Text="Won reasons" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel15" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel16" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
  ...
  <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label30" runat="server" Text="Lost Reason" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel17" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel18" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
           ...
           <div class="open3 "  style="font-size:20px;border: 1px solid #cccccc; padding:7px; margin:10px;color: #3a5a7a; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif;">
                  ...
                  <div class="toop">
                     <asp:Label ID="Label34" runat="server" Text="Customer Type" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel19" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel20" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label41" runat="server" Text="Account Ownership" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel21" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel22" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label45" runat="server" Text="Account Rating" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel23" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel24" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label49" runat="server" Text="Segment" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel25" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel26" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                    <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label53" runat="server" Text="Competitor" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel27" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel28" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label57" runat="server" Text="No Of Employees" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel29" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel30" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label61" runat="server" Text="Industry" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel31" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel32" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label65" runat="server" Text="Name title" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel33" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel34" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label69" runat="server" Text="Designation" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel35" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel36" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"  >
                       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label73" runat="server" Text="Country" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel37" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel38" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                    <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label77" runat="server" Text="Task Status" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel39" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel40" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Designation</h3> 
                     </div>
...
<br />
          ...
          <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label81" runat="server" Text="Task Type" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel41" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel42" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
...
<div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label85" runat="server" Text="Quote Stage" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel43" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel44" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label89" runat="server" Text="Quote Validity" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel45" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
                     
                     
                     
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; ">Add a new Quote validity</h3> 
                     </div>
                   <br />
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel46" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Quote validity</h3> 
                     </div>
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label93" runat="server" Text="Delivery Lead Time" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel47" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel48" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label97" runat="server" Text="Shipping" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel49" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel50" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Shipping</h3> 
                     </div>
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label101" runat="server" Text="Payment Terms" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel51" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none" >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel52" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"  >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label105" runat="server" Text="Ticket Status" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel53" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel54" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"  >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label109" runat="server" Text="Severity" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel55" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel56" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                    <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label113" runat="server" Text="Ticket category" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel57" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none" >
                     
                     
                     
                   <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; ">Add a new Ticket category</h3> 
                     </div>
                   <br />
    ...
    <ContentTemplate>
                      ...
                      <asp:GridView ID="GridView29" runat="server" CellPadding="4" ForeColor="#333333" 
                          ...
                          <Columns>
                             ...
                             <asp:BoundField DataField="Ticket_category" HeaderText="Ticket category" />
                      ...
                      <asp:Panel ID="Panel58" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this ticket category</h3> 
                     </div>
...
<br />
           ...
           <div class="open5 "  style="font-size:20px;border: 1px solid #cccccc; padding:7px; margin:10px;color: #3a5a7a; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif;">
                  ...
                  <div class="toop">
                     <asp:Label ID="Label117" runat="server" Text="Sales Order Stage" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel59" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel60" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label121" runat="server" Text="Invoice" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel61" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none" >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel62" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                    <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this invoice</h3> 
                     </div>
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label10" runat="server" Text="Invoice Tax %" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:ImageButton ID="ImageButton130" runat="server"  Width="20px"  Height="20px" ImageUrl="~/plus.png" style="margin-top:5px; margin-right:30px; float:right" />
                  </div>
                      <asp:Panel ID="Panel87" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none" >
                     
                     
                     
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; ">Add a new Invocie Tax %</h3> 
                     </div>
                   <br />
                      
          <asp:UpdatePanel ID="UpdatePanel220" runat="server" >
                    <ContentTemplate>
                          <asp:TextBox ID="TextBox97" runat="server" style="width:90%;height:40px;border-radius:5px; margin-left:10px; border:solid 1px gray;"></asp:TextBox>
                                </ContentTemplate> 
                                <Triggers>
        
           <asp:AsyncPostBackTrigger ControlID = "Button219" EventName="Click" />
        </Triggers>
                              </asp:UpdatePanel>    
                          <br />
                          <br />
                    ...
                    <ContentTemplate>
                          <asp:Button ID="Button219" runat="server" Text="Save" 
                                onclick="Button219_Click" /> </ContentTemplate> 
                              
                              </asp:UpdatePanel>  
         
          </td>
                          <td>&nbsp;&nbsp;
                              <asp:Button ID="Button220" runat="server" class="btn btn-info" Text="cancel"  /></td>
                      </tr>
                      </table>
                      </div>
                      </asp:Panel>
                      <asp:ModalPopupExtender ID="ModalPopupExtender87" runat="server" TargetControlID="ImageButton130" CancelControlID="Button220" PopupControlID="Panel87" BackgroundCssClass="modelbackground">
                      </asp:ModalPopupExtender>
                        <asp:UpdatePanel ID="UpdatePanel222" runat="server" >
    <ContentTemplate>
                      <div class="grid">
                    
                      <asp:GridView ID="GridView46" runat="server" CellPadding="4" ForeColor="#333333" 
                              Width="100%" AutoGenerateColumns="False" 
                          GridLines="None" ShowHeader="False" AllowSorting="True">
                          <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                          <Columns>
                             ...
                             <asp:BoundField DataField="Invoice_Tax" HeaderText="Invoice Tax" />
                            

                          <asp:TemplateField>
                          <ItemTemplate>
                      <asp:ImageButton ID="ImageButton131" runat="server"  ImageUrl="~/edit4.jpg" CssClass="edit" onclick="ImageButton131_Click"></asp:ImageButton>
                          ...
                          <asp:ImageButton ID="ImageButton132" runat="server" ImageUrl="~/delete3.png" CssClass="delete" onclick="ImageButton132_Click"></asp:ImageButton>
                          </ItemTemplate>
                      ...
                      <asp:Panel ID="Panel88" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                    <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Invoice tax %</h3> 
                     </div>
                    
                          <asp:Label ID="Label12" runat="server" Text="Label" Visible="False"></asp:Label></td>
                     <br />
                          <asp:TextBox ID="TextBox98" runat="server" style="width:90%;height:40px;border-radius:5px; margin-left:10px; border:solid 1px gray;"></asp:TextBox></td>
                      <br />
<br />
                    ...
                    <ContentTemplate>
                          <asp:Button ID="Button222" runat="server" Text="Update" class="btn btn-info"  
                       ...
                       <ContentTemplate>
                              <asp:Button ID="Button223" runat="server" Text="cancel" class="btn btn-info"   /> 
                              </ContentTemplate> 
                      ...
                      <asp:ModalPopupExtender ID="ModalPopupExtender88" runat="server" TargetControlID="Button221" CancelControlID="Button223" PopupControlID="Panel88" BackgroundCssClass="modelbackground">
                      </asp:ModalPopupExtender>
         ...
         <Triggers>
          <asp:AsyncPostBackTrigger ControlID = "GridView46" />
         <asp:AsyncPostBackTrigger ControlID = "Button219" EventName="Click" />
          <asp:AsyncPostBackTrigger ControlID = "Button222" EventName="Click" />
           <asp:AsyncPostBackTrigger ControlID = "Button223" EventName="Click" />
        </Triggers>
     ...
     <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label14" runat="server" Text="Dispatched Through" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:ImageButton ID="ImageButton133" runat="server"  Width="20px"  Height="20px" ImageUrl="~/plus.png" style="margin-top:5px; margin-right:30px; float:right" />
                  </div>
                      <asp:Panel ID="Panel89" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none" >
                     
                     
                     
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; ">Add a new Dispatched through</h3> 
                     </div>
                   <br />
                      
          <asp:UpdatePanel ID="UpdatePanel225" runat="server" >
                    <ContentTemplate>
                          <asp:TextBox ID="TextBox106" runat="server" style="width:90%;height:40px;border-radius:5px; margin-left:10px; border:solid 1px gray;"></asp:TextBox>
                                </ContentTemplate> 
                                <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button219" EventName="Click" />
                    ...
                    <ContentTemplate>
                          <asp:Button ID="Button225" runat="server" Text="Save" 
                                onclick="Button225_Click" /> </ContentTemplate> 
                              
                              </asp:UpdatePanel>  
         
          </td>
                          <td>&nbsp;&nbsp;
                              <asp:Button ID="Button226" runat="server" class="btn btn-info" Text="cancel"  /></td>
                      </tr>
                      </table>
                      </div>
                      </asp:Panel>
                      <asp:ModalPopupExtender ID="ModalPopupExtender89" runat="server" TargetControlID="ImageButton133" CancelControlID="Button226" PopupControlID="Panel89" BackgroundCssClass="modelbackground">
                      </asp:ModalPopupExtender>
                        <asp:UpdatePanel ID="UpdatePanel227" runat="server" >
    <ContentTemplate>
                      <div class="grid">
                    
                      <asp:GridView ID="GridView47" runat="server" CellPadding="4" ForeColor="#333333" 
                              Width="100%" AutoGenerateColumns="False" 
                          GridLines="None" ShowHeader="False" AllowSorting="True">
                          <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                          <Columns>
                             ...
                             <asp:BoundField DataField="Dispatched_through" HeaderText="Dispatched through" />
                            

                          <asp:TemplateField>
                          <ItemTemplate>
                  
                          <asp:ImageButton ID="ImageButton134" runat="server" ImageUrl="~/edit4.jpg" CssClass="edit" onclick="ImageButton134_Click"></asp:ImageButton>
                          </ItemTemplate>
                       ...
                       <asp:ImageButton ID="ImageButton135" runat="server" ImageUrl="~/delete3.png" CssClass="delete" onclick="ImageButton135_Click"></asp:ImageButton>
                      ...
                      <asp:Button ID="Button227" runat="server" Text="Button" style="display:none" />
                      <asp:Panel ID="Panel90" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                    <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Dispatched through</h3> 
                     </div>
                    
                          <asp:Label ID="Label20" runat="server" Text="Label" Visible="False"></asp:Label></td>
                     <br />
                          <asp:TextBox ID="TextBox107" runat="server" style="width:90%;height:40px;border-radius:5px; margin-left:10px; border:solid 1px gray;"></asp:TextBox></td>
                      <br />
<br />
                    ...
                    <ContentTemplate>
                          <asp:Button ID="Button228" runat="server" Text="Update" class="btn btn-info"  
                       ...
                       <ContentTemplate>
                              <asp:Button ID="Button229" runat="server" Text="cancel" class="btn btn-info"   /> 
                              </ContentTemplate> 
                      ...
                      <asp:ModalPopupExtender ID="ModalPopupExtender90" runat="server" TargetControlID="Button227" CancelControlID="Button229" PopupControlID="Panel90" BackgroundCssClass="modelbackground">
                      </asp:ModalPopupExtender>
         ...
         <Triggers>
          <asp:AsyncPostBackTrigger ControlID = "GridView47" />
         <asp:AsyncPostBackTrigger ControlID = "Button228" EventName="Click" />
          <asp:AsyncPostBackTrigger ControlID = "Button229" EventName="Click" />
           <asp:AsyncPostBackTrigger ControlID = "Button225" EventName="Click" />
        </Triggers>
  ...
  <div class="panel-body">
                 ...
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Company Name</label>
                                    ...
                                    <div class="col-lg-9"><asp:TextBox ID="TextBox99" runat="server" TextMode="MultiLine" height="50px" class="dropbox"></asp:TextBox>
                                    </div>
                                </div>
                                 <div class="form-group"><label class="col-lg-3 control-label">Company Address</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox104" runat="server" TextMode="MultiLine" height="80px" class="dropbox"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Bank name</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox100" runat="server" class="dropbox"></asp:TextBox></div>
                                </div>

                                  <div class="form-group"><label class="col-lg-3 control-label">Account No</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox101" runat="server" class="dropbox"></asp:TextBox></div>
                                </div>

                                 <div class="form-group"><label class="col-lg-3 control-label">Branch</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox102" runat="server" class="dropbox"></asp:TextBox></div>
                                </div>
                                  <div class="form-group"><label class="col-lg-3 control-label">IFS Code</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox103" runat="server" class="dropbox"></asp:TextBox></div>
                                </div>
                                  <div class="form-group"><label class="col-lg-3 control-label">Terms and Conditions</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox105" runat="server" class="dropbox" TextMode="MultiLine"  Height="70px"></asp:TextBox></div>
                                </div>
                                
                                  <asp:Button ID="Button224" runat="server" Text="Save" onclick="Button224_Click"></asp:Button>
           ...
           <div class="open6 "  style="font-size:20px;border: 1px solid #cccccc; padding:7px; margin:10px;color: #3a5a7a; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif;">
                  ...
                  <div class="toop">
                     <asp:Label ID="Label125" runat="server" Text="Product Category" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel63" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel64" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label129" runat="server" Text="Product Type" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel65" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel66" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"  >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label133" runat="server" Text="Tax Type" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel67" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel68" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"  >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label137" runat="server" Text="Designation" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel69" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel70" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Designation</h3> 
                     </div>
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label141" runat="server" Text="Currency" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel71" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel72" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"  >
         <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
...
<br />
    ...
    <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label145" runat="server" Text="Custom Field" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel73" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel74" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Designation</h3> 
                     </div>
...
<br />
         ...
         <asp:AsyncPostBackTrigger ControlID = "Button90" EventName="Click" />
          <asp:AsyncPostBackTrigger ControlID = "Button91" EventName="Click" />
           ...
           <div class="open14 "  style="font-size:20px;border: 1px solid #cccccc; padding:7px; margin:10px;color: #3a5a7a; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif;">
                                        FiltFilters&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span   class="fa fa-sort-desc" aria-hidden="true"></span></div>
                ...
                <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label149" runat="server" Text="Created" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel75" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel76" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:10px; border:1px solid gray; background-color:gray;color:white;  border-radius:10px;">
...
<br />
                 ...
                 <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label153" runat="server" Text="Active" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel77" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel78" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                      <div style="padding:10px; border:1px solid gray; background-color:gray;color:white;  border-radius:10px;">
...
<br />
                ...
                <div class="col-md-3">
                  <div class="toop">
                     <asp:Label ID="Label157" runat="server" Text="Modified" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <asp:Panel ID="Panel79" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panelx" style="display:none"  >
    ...
    <ContentTemplate>
                      ...
                      <asp:Panel ID="Panel80" runat="server"  BorderColor="#999999" BackColor="White" BorderWidth="1px" CssClass="panely" style="display:none"   >
                     <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; "> Update this Designation</h3> 
                     </div>
