...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
 ...
 <ul class="nav nav-second-level collapse">
  ...
  <div class="col-md-12">
   ...
   <ContentTemplate>
   <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true"  onselectedindexchanged="DropDownList2_SelectedIndexChanged"  ></asp:DropDownList>
     </ContentTemplate>
                               </asp:UpdatePanel>
   ...
   <ContentTemplate>
   <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList>
    </ContentTemplate>
                                <Triggers>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Sub Category Id</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Category</label>
                                   ...
                                   <asp:DropDownList ID="DropDownList3" runat="server" CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList>
                                     
                                    </div>
                                </div>


                                <div class="form-group"><label class="col-lg-3 control-label">Sub Category Name</label>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Sub Category Id" DataField="subcategory_id"  />
