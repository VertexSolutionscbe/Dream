<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Task_show.aspx.cs" Inherits="Admin_Task_show" %>
...
arrow"></span></a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                  <h2><asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<span style="font-size:16px">Created By <asp:Label ID="Label2" runat="server" Text=""></asp:Label>&nbsp;On <asp:Label ID="Label15" runat="server" Text="Label"></asp:Label></span><Span style="float:right"> <asp:DropDownList ID="DropDownList1" runat="server" CssClass="selectpicker" style="font-size:20px" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList> <asp:LinkButton ID="btnRandom" runat="server" CssClass="btn btn-primary" 
  ...
  <div class="col-md-12">
    <div class="col-md-3 s1">
           <div>
           <h1 style="text-align:center; padding-top:10px;">type</h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">status</h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Due Date</h1>
     ...
     <div class="col-md-3 s4">
         <div>
           <h1 style="text-align:center; padding-top:10px;">Proiority</h1>
    ...
    <div class="col-md-12">
    <div class="col-md-3 s5 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Associated To</h4>
     ...
     <div class="col-md-3 s6 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Last Modified</h4>
     ...
     <div class="col-md-3 s7 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Assigned To</h4>
   ...
   <div class="col-md-3 s7 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Completed on</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label10" runat="server" Text=""></asp:Label></h1>
   ...
   <div class="col-md-12">
    <div class="col-md-3 s5 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Due Time</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label11" runat="server" Text=""></asp:Label></h1>
     ...
     <div class="col-md-3 s6 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Contact Name</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label12" runat="server" Text=""></asp:Label></h1>
     ...
     <div class="col-md-3 s7 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Phone</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label13" runat="server" Text=""></asp:Label></h1>
   ...
   <div class="col-md-3 s7 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Email</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label14" runat="server" Text=""></asp:Label></h1>
