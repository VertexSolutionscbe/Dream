...
public partial class Settings : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           ...
           dr=cmd.ExecuteReader();
            if(dr.Read())
            {
                TextBox99.Text=dr["Company_name"].ToString();
                TextBox104.Text=dr["company_details"].ToString();
                TextBox100.Text=dr["Bank_name"].ToString();
                TextBox101.Text=dr["acc_no"].ToString();
                TextBox102.Text=dr["branch"].ToString();
                TextBox103.Text=dr["IFS_code"].ToString();
                TextBox105.Text = dr["terms_conditions"].ToString();
            }
        }
    ...
    private void getAwarrantytype()
    {
          ...
          company_id = Convert.ToInt32(Session["company_id"].ToString());   SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
          SqlCommand CMD = new SqlCommand("select * from Ticket_category where com_id='" + company_id + "'", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
    ...
    protected void ImageButton86_Click(object sender, ImageClickEventArgs e)
    {
        ...
        TextBox58.Text = ROW.Cells[0].Text;
          ...
          company_id = Convert.ToInt32(Session["company_id"].ToString());  
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd1 = new SqlCommand("Select * from Ticket_category where Ticket_category='" + ROW.Cells[0].Text + "'  and com_id='" + company_id + "'", con);
        con.Open();
        SqlDataReader dr;
        dr = cmd1.ExecuteReader();
        if (dr.Read())
    ...
    protected void ImageButton87_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("delete from Ticket_category where Ticket_category='" + ROW.Cells[0].Text + "'  and com_id='" + company_id + "'", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
        getAwarrantytype();
    ...
    protected void Button145_Click(object sender, EventArgs e)
    {
          company_id = Convert.ToInt32(Session["company_id"].ToString());   
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd = new SqlCommand("update Ticket_category set Ticket_category=@Ticket_category where No='" + Label115.Text + "' and com_id='" + company_id + "'", con);

        con.Open();
        cmd.Parameters.AddWithValue("@Ticket_category", TextBox58.Text);
        cmd.ExecuteNonQuery();
        con.Close();
        getAwarrantytype();
    ...
    protected void Button142_Click(object sender, EventArgs e)
    {
        ...
        else
        {
              company_id = Convert.ToInt32(Session["company_id"].ToString());   
            SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
            SqlCommand cmd = new SqlCommand("insert into Ticket_category values(@Ticket_category,@com_id)", con);

            con.Open();
            cmd.Parameters.AddWithValue("@Ticket_category", TextBox57.Text);
            cmd.Parameters.AddWithValue("@com_id", company_id);
            cmd.ExecuteNonQuery();
            con.Close();
            TextBox57.Text = "";
            getAwarrantytype();
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Ticket category created successfully')", true);
        }
    }
    ...
    protected void Button155_Click(object sender, EventArgs e)
    {
          company_id = Convert.ToInt32(Session["company_id"].ToString());  
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd = new SqlCommand("update Invoice_value set Invoice_value=@Invoice_value where No='" + Label123.Text + "' and com_id='"+company_id+"'", con);
    ...
    private void Invoice_tax()
    {

        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from Invoice_Tax where com_id='" + company_id + "'", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView46.DataSource = dt1;
        GridView46.DataBind();
    ...
    protected void ImageButton131_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ImageButton IMG = (ImageButton)sender;
        GridViewRow ROW = (GridViewRow)IMG.NamingContainer;
        TextBox98.Text = ROW.Cells[0].Text;
        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd1 = new SqlCommand("Select * from Invoice_Tax where Invoice_Tax='" + ROW.Cells[0].Text + "'  and com_id='" + company_id + "' and com_id='" + company_id + "'", con);
        con.Open();
        SqlDataReader dr;
        dr = cmd1.ExecuteReader();
        if (dr.Read())
        ...
        this.ModalPopupExtender88.Show();
    ...
    protected void ImageButton132_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("delete from Invoice_Tax where Invoice_Tax='" + ROW.Cells[0].Text + "'   and com_id='" + company_id + "'", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
        Invoice_tax();
    ...
    protected void Button222_Click(object sender, EventArgs e)
    {
        ...
        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd = new SqlCommand("update Invoice_Tax set Invoice_Tax=@Invoice_Tax where No='" + Label12.Text + "' and com_id='" + company_id + "'", CON);

        CON.Open();
        cmd.Parameters.AddWithValue("@Invoice_Tax", TextBox98.Text);
        cmd.ExecuteNonQuery();
        CON.Close();
        Invoice_tax();
    ...
    protected void Button219_Click(object sender, EventArgs e)
    {
        if (TextBox97.Text == "")
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Please enter Invoice Tax ')", true);
        }
        else
        {
            company_id = Convert.ToInt32(Session["company_id"].ToString());
            SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
            SqlCommand cmd = new SqlCommand("insert into Invoice_Tax values(@Invoice_Tax,@com_id)", CON);

            CON.Open();
            cmd.Parameters.AddWithValue("@Invoice_Tax", TextBox97.Text);
            cmd.Parameters.AddWithValue("@com_id", company_id);
            cmd.ExecuteNonQuery();
            CON.Close();
            TextBox97.Text = "";
            Invoice_tax();
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Invoice Tax % created successfully')", true);
        }
    }
    protected void Button224_Click(object sender, EventArgs e)
    {
        if (TextBox99.Text == "")
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Please enter Invoice details ')", true);
        }
        else
        {
             company_id = Convert.ToInt32(Session["company_id"].ToString());
                ...
                SqlCommand cmd1 = new SqlCommand("select * from Bank_details where No=1 and com_id='" + company_id + "'", con1);
                con1.Open();
                SqlDataReader dr1;
                ...
                if (dr1.Read())
                {
                    ...
                    SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                    SqlCommand cmd = new SqlCommand("update Bank_details set Company_name=@Company_name,company_details=@company_details,Bank_name=@Bank_name,acc_no=@acc_no,branch=@branch,IFS_code=@IFS_code where no=1 and com_id='" + company_id + "'", CON);

                    CON.Open();
                    cmd.Parameters.AddWithValue("@Company_name", TextBox99.Text);
                    cmd.Parameters.AddWithValue("@company_details", TextBox104.Text);
                    cmd.Parameters.AddWithValue("@Bank_name", TextBox100.Text);
                    cmd.Parameters.AddWithValue("@acc_no", TextBox101.Text);
                    cmd.Parameters.AddWithValue("@branch", TextBox102.Text);
                    cmd.Parameters.AddWithValue("@IFS_code", TextBox103.Text);
                   
                    cmd.ExecuteNonQuery();
                    CON.Close();
                
                    getcompaign();
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Invoice details updated successfully')", true);
                ...
                else
                {
                    ...
                    company_id = Convert.ToInt32(Session["company_id"].ToString());
                    SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                    SqlCommand cmd = new SqlCommand("insert into Bank_details values(@Company_name,@company_details,@Bank_name,@acc_no,@branch,@IFS_code,@com_id,@terms_conditions)", CON);
                    ...
                    cmd.Parameters.AddWithValue("@IFS_code", TextBox103.Text);
                    cmd.Parameters.AddWithValue("@com_id", company_id);
                    cmd.Parameters.AddWithValue("@terms_conditions", TextBox105.Text);
                    cmd.ExecuteNonQuery();
                    CON.Close();
                  
                    getcompaign();
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Invoice details created successfully')", true);
                }
        }
    ...
    private void Dispatched_Through()
    {
        ...
        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from Dispatched_through where com_id='" + company_id + "'", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView47.DataSource = dt1;
        GridView47.DataBind();
    ...
    protected void ImageButton134_Click(object sender, ImageClickEventArgs e)
    {

        ImageButton IMG = (ImageButton)sender;
        GridViewRow ROW = (GridViewRow)IMG.NamingContainer;
        TextBox107.Text = ROW.Cells[0].Text;
        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd1 = new SqlCommand("Select * from Dispatched_through where Dispatched_through='" + ROW.Cells[0].Text + "'  and com_id='" + company_id + "'", con);
        con.Open();
        SqlDataReader dr;
        dr = cmd1.ExecuteReader();
        if (dr.Read())
        {
            no = Convert.ToInt32(dr["No"].ToString());
            Label20.Text = no.ToString();
        }
        this.ModalPopupExtender90.Show();

    }
    protected void ImageButton135_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("delete from Dispatched_through where Dispatched_through='" + ROW.Cells[0].Text + "' and com_id='" + company_id + "'", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
        Dispatched_Through();
    ...
    protected void Button228_Click(object sender, EventArgs e)
    {
        ...
        company_id = Convert.ToInt32(Session["company_id"].ToString());
        SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd = new SqlCommand("update Dispatched_through set Dispatched_through=@Dispatched_through where No='" + Label20.Text + "' and  com_id='" + company_id + "'", CON);

        CON.Open();
        cmd.Parameters.AddWithValue("@Dispatched_through", TextBox107.Text);
        cmd.ExecuteNonQuery();
        CON.Close();
        Dispatched_Through();
    ...
    protected void Button225_Click(object sender, EventArgs e)
    {
        if (TextBox106.Text == "")
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Please enter Dispatched_through ')", true);
        }
        else
        {
            company_id = Convert.ToInt32(Session["company_id"].ToString());
            SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
            SqlCommand cmd = new SqlCommand("insert into Dispatched_through values(@Dispatched_through,@com_id)", CON);

            CON.Open();
            cmd.Parameters.AddWithValue("@Dispatched_through", TextBox106.Text);
            cmd.Parameters.AddWithValue("@com_id", company_id);
            cmd.ExecuteNonQuery();
            CON.Close();
            TextBox106.Text = "";
            Dispatched_Through();
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Dispatched_through created successfully')", true);
        }
    }
