                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                 <h2><asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<span style="font-size:16px">Created By<span style="color:#ff5f5f"> <asp:Label ID="Label2" runat="server" Text=""></asp:Label></span> &nbsp; On<span style="color:#ff5f5f"> <asp:Label ID="Label35" runat="server" Text="Label"></asp:Label></span></span><Span style="float:right"><asp:Button ID="Button1" runat="server" Text="Active"></asp:Button><asp:Button ID="Button2" runat="server" Text="Inactive"></asp:Button>  <asp:LinkButton ID="btnRandom" runat="server" CssClass="btn btn-primary" 
                                    ...
                                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-primary" 
                                             ><span aria-hidden="true" class="glyphicon glyphicon-remove"></span> &nbsp;Delete</asp:LinkButton> </Span> <small></small></h2>
